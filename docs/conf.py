...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            '-o',
            str(DOCS / 'API'),
            os.path.join(DOCS / '..' / 'src' / 'pypkg_gh_releases_01'),
        ]
    )
...
source_suffix = '.rst'
master_doc = 'index'
project = 'PyPkg Gh-Releases 01'
year = str(datetime.datetime.now().year)
author = 'Michael Goerz'
copyright = '{0}, {1}'.format(year, author)
version = pypkg_gh_releases_01.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/goerz-testing/pypkg_gh_releases_01/issues/%s', '#'),
    'pr': ('https://github.com/goerz-testing/pypkg_gh_releases_01/pull/%s', 'PR #'),
}
