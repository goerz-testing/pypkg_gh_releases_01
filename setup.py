...
version = get_version('./src/pypkg_gh_releases_01/__init__.py')
...
setup(
    ...
    keywords='pypkg_gh_releases_01',
    name='pypkg_gh_releases_01',
    packages=find_packages(where="src"),
    package_dir={"": "src"},
    url='https://github.com/goerz-testing/pypkg_gh_releases_01',
    version=version,
    zip_safe=False,
)
